...
import { Plus, FileText, Copy, BookOpen, ArrowRight } from 'lucide-react';
      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto px-4 pt-32 pb-16">
          <div className="max-w-5xl mx-auto">
                ...
                <DialogContent className="bg-black/90 border-white/10 text-white backdrop-blur-xl">
                  ...
                  <div className="space-y-4 mt-4">
                    ...
                    <div className="pt-4 flex justify-end space-x-2">
                      <Button variant="outline" onClick={() => setIsDialogOpen(false)} className="border-white/20 bg-white/5 hover:bg-white/10">
                        Cancel
                      </Button>
                      <Button onClick={handleCreateExam} className="bg-gradient-to-r from-blue-500 to-violet-600 hover:from-blue-600 hover:to-violet-700">
                        Create Exam
                      </Button>
                    </div>
                  </div>
            ...
            <h2 className="text-2xl font-semibold mb-4 text-white">Your Exam List</h2>
                      ...
                      <div className="flex justify-between items-center mt-4">
                        ...
                        <div className="flex space-x-2">
                          <Button 
                            ...
                            size="sm"
                            className="border-white/20 bg-white/5 hover:bg-white/10"
                            onClick={() => window.location.href = `/dashboard?examId=${exam.id}`}
                          >
